...
type DebuggingContainerEvent struct {
	...
	AppRoots             []string          `protobuf:"bytes,9,rep,name=appRoots,proto3" json:"appRoots,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *DebuggingContainerEvent) GetAppRoots() []string {
	if m != nil {
		return m.AppRoots
	}
	return nil
...
var fileDescriptor_4f2d38e344f9dbf5 = []byte{
	...
	,
}
